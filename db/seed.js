...
var data = {
  users: [
    ...
    { name: 'Swag Master', email: 'Swag@gmail.com', addresses: ['5 Hanover Square, New York, NY, 10004'], isAdmin: true, password: 'abcd' },
    { name: 'Sag Mistress', email: 'Sag@gmail.com', addresses: ['5 Hanover Square, New York, NY, 10004'], isAdmin: false, password: 'efgh' },
    { name: 'Random Man', email: 'Man@gmail.com', addresses: ['10 SandOver Pear, New York, NY, 11111'], isAdmin: false, password: 'ijkl' }
  ],
